...
from utils.ImageDataGenerator import LN_generator
# Display
...
def trainer(valid_data='3.0T'): 
    ...
    #     data loader
    path_valid, X_train, X_valid, y_train, y_valid= data_loder(valid_data='3.0T')
    ...
    #     generateor
    train_generator, valid_generator = LN_generator(X_train, y_train, X_valid, y_valid, batch_size)
    # model.summary()
