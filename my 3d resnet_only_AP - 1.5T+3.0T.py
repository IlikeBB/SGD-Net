...
from utils.ImageDataGenerator import AP_generateor
...
def data_loder(valid_data='3.0T'):
    ...
    if valid_data=='3.0T':
        ...
        path_valid = np.concatenate((valid_path_30T,valid_path_15T))
...
def trainer(valid_data='3.0T'): 
    ...
    train_generator, valid_generator = AP_generateor(X_train, y_train, X_valid, y_valid, batch_size)
